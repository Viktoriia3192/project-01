...
`,Pe=S(Fe)`
  ...
  font-size: 14px;
  color: var(--secondary-color-red);
`,V=({iconName:e,width:r,height:t,stroke:n,fill:i})=>s.jsx("svg",{width:r||"24px",height:t||"24px",children:s.jsx("use",{href:`${He}#${e}`,stroke:n,fill:i})});V.propTypes={iconName:q.string.isRequired,width:q.string,height:q.string,stroke:q.string,fill:q.string};const ht=Me().shape({email:Q().email("Please enter a valid email").required("E-mail is required"),password:Q().min(8,"Password must be 8 or more characters").max(64).required("Password is required")}),mt=()=>{const[e,r]=M.useState(!1),t=Oe(),n={email:"",password:""},i=({email:a,password:o},{resetForm:c})=>{event.preventDefault(),t(Ge({email:a,password:o})),c()};return s.jsx(Re,{initialValues:n,validationSchema:ht,onSubmit:i,children:s.jsx(At,{children:s.jsxs(ut,{children:[s.jsx("h1",{children:"Sign In"}),s.jsxs("div",{className:dt.signInFields,children:[s.jsxs("label",{children:[s.jsx(ke,{children:"Enter your email"}),s.jsx(Z,{name:"email",type:"email",placeholder:"E-mail"}),s.jsx(Pe,{name:"email",component:"span"})]}),s.jsxs("label",{children:[s.jsx(ke,{children:"Enter your password"}),s.jsxs("div",{children:[s.jsx(Z,{name:"password",type:e?"text":"password",placeholder:"Password"}),s.jsx(ft,{type:"button",onClick:()=>r(!e),children:e?s.jsx(V,{iconName:"icon-eye",width:"16px",height:"16px"}):s.jsx(V,{iconName:"icon-eye-slash",width:"16px",height:"16px"})})]}),s.jsx(Pe,{name:"password",component:"span"})]}),s.jsx(pt,{type:"submit",children:"Sign In"})]}),s.jsx(Ie,{to:"/signup",children:"Sign Up"})]})})})},gt="_inputFields_lufqz_1",Te={inputFields:gt},xt=S.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,se=S(Fe)`
  ...
  font-size: 14px;
  color: var(--secondary-color-red);
`,vt=Me().shape({email:Q().email("Please enter a valid email").required("E-mail is required"),password:Q().min(8,"Password must be 8 or more characters").max(64).required("Password is required"),repeatPassword:Q().oneOf([$e("password"),null],"The passwords do not match").required("Repeat password field is required")}),wt=()=>{const[e,r]=M.useState(!1),[t,n]=M.useState(!1),i=Oe(),a={email:"",password:"",repeatPassword:""},o=({email:c,password:u},{resetForm:g})=>{event.preventDefault(),i(_e({email:c,password:u})),g()};return s.jsx(Re,{initialValues:a,validationSchema:vt,onSubmit:o,children:c=>s.jsx(xt,{children:s.jsxs(bt,{children:[s.jsx("h1",{children:"Sign Up"}),s.jsxs("div",{className:Te.inputFields,children:[s.jsxs("label",{children:[s.jsx(oe,{children:"Enter your email"}),s.jsx(Z,{name:"email",type:"email",placeholder:"E-mail"}),s.jsx(se,{name:"email",component:"span"})]}),s.jsxs("label",{children:[s.jsx(oe,{children:"Enter your password"}),s.jsxs("div",{children:[s.jsx(Z,{name:"password",type:e?"text":"password",placeholder:"Password"}),s.jsx(Ce,{type:"button",onClick:()=>r(!e),children:e?s.jsx(V,{iconName:"icon-eye",width:"16px",height:"16px"}):s.jsx(V,{iconName:"icon-eye-slash",width:"16px",height:"16px"})})]}),s.jsx(se,{name:"password",component:"span"})]}),s.jsxs("label",{children:[s.jsx(oe,{children:"Repeat password"}),s.jsxs("div",{children:[s.jsx(Z,{name:"repeatPassword",type:t?"text":"password",placeholder:"Password"}),s.jsx(Ce,{type:"button",onClick:()=>n(!t),children:t?s.jsx(V,{iconName:"icon-eye",width:"16px",height:"16px"}):s.jsx(V,{iconName:"icon-eye-slash",width:"16px",height:"16px"})})]}),s.jsx(se,{name:"repeatPassword",component:"span"})]}),s.jsx(yt,{type:"submit",children:"Sign Up"})]}),s.jsx(Ie,{className:Te.signInLink,to:"/signin",onClick:()=>{c.handleReset()},children:"Sign in"})]})})})},kt=({isRegister:e=!1})=>e?s.jsx(wt,{}):s.jsx(mt,{}),Pt=S.div`
  margin: 0 auto;
  width: 100%;
  padding-left: 32px;
  padding-right: 32px;
`,Tt=S.div`
  ...
  @media (min-device-pixel-ratio: 2),
    ...
    background-image: url(${tt}), url(${Se});
  }
  ...
  @media (min-width: 1440px) {
    ...
    top: 60px;
    left: 18px;
    background-image: url(${at}), url(${ot});
    ...
    @media (min-device-pixel-ratio: 2),
      ...
      (min-resolution: 192dpi),
      (min-resolution: 2dppx) {
      background-image: url(${st}), url(${ct});
    }
  }
`,Ct=S.p`
  margin-top: 20px;
...
`;export{kt as A,Pt as S,Se as a,tt as b,it as c,at as d,ot as e,st as f,ct as g,Tt as h,Ct as i,rt as m,S as n,nt as t};
