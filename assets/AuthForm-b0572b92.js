...
`,v=o(j)`
  ...
  font-size: 14px;
  color: var(--secondary-color-orange);
`,t=({iconName:e,width:r,height:s,stroke:i,fill:n})=>A.jsx("svg",{width:r||"24px",height:s||"24px",children:A.jsx("use",{href:`${I}#${e}`,stroke:i,fill:n})});t.propTypes={iconName:l.string.isRequired,width:l.string,height:l.string,stroke:l.string,fill:l.string};const X=w().shape({email:p().email("Please enter a valid email").required("E-mail is required"),password:p().min(8,"Password must be 8 or more characters").max(64).required("Password is required")}),K=()=>{const[e,r]=b.useState(!1),s=V(),i={email:"",password:""},n=({email:d,password:m},{resetForm:a})=>{event.preventDefault(),s(B({email:d,password:m})),a()};return A.jsx(U,{initialValues:i,validationSchema:X,onSubmit:n,children:A.jsx(z,{children:A.jsxs(J,{children:[A.jsx("h1",{children:"Sign In"}),A.jsxs("label",{children:[A.jsx(y,{children:"Enter your email"}),A.jsx(c,{name:"email",type:"email",placeholder:"E-mail"}),A.jsx(v,{name:"email",component:"span"})]}),A.jsxs("label",{children:[A.jsx(y,{children:"Enter your password"}),A.jsxs("div",{children:[A.jsx(c,{name:"password",type:e?"text":"password",placeholder:"Password"}),A.jsx(R,{type:"button",onClick:()=>r(!e),children:e?A.jsx(t,{iconName:"icon-eye",width:"16px",height:"16px"}):A.jsx(t,{iconName:"icon-eye-slash",width:"16px",height:"16px"})})]}),A.jsx(v,{name:"password",component:"span"})]}),A.jsx(O,{type:"submit",children:"Sign In"}),A.jsx(P,{to:"/signup",children:"Sign Up"})]})})})},C=o.div`
  display: flex;
  flex-direction: column;
  padding-left: 20px;
  padding-right: 20px;
...
`,g=o(j)`
  ...
  font-size: 14px;
  color: var(--secondary-color-orange);
`,G=w().shape({email:p().email("Please enter a valid email").required("E-mail is required"),password:p().min(8,"Password must be 8 or more characters").max(64).required("Password is required"),repeatPassword:p().oneOf([L("password"),null],"The passwords do not match").required("Repeat password field is required")}),H=()=>{const[e,r]=b.useState(!1),[s,i]=b.useState(!1),n=V(),d={email:"",password:"",repeatPassword:""},m=({email:a,password:x},{resetForm:h})=>{event.preventDefault(),n(Z({email:a,password:x})),h()};return A.jsx(U,{initialValues:d,validationSchema:G,onSubmit:m,children:a=>A.jsx(C,{children:A.jsxs(W,{children:[A.jsx("h1",{children:"Sign Up"}),A.jsxs("label",{children:[A.jsx(u,{children:"Enter your email"}),A.jsx(c,{name:"email",type:"email",placeholder:"E-mail"}),A.jsx(g,{name:"email",component:"span"})]}),A.jsxs("label",{children:[A.jsx(u,{children:"Enter your password"}),A.jsxs("div",{children:[A.jsx(c,{name:"password",type:e?"text":"password",placeholder:"Password"}),A.jsx(S,{type:"button",onClick:()=>r(!e),children:e?A.jsx(t,{iconName:"icon-eye",width:"16px",height:"16px"}):A.jsx(t,{iconName:"icon-eye-slash",width:"16px",height:"16px"})})]}),A.jsx(g,{name:"password",component:"span"})]}),A.jsxs("label",{children:[A.jsx(u,{children:"Repeat password"}),A.jsxs("div",{children:[A.jsx(c,{name:"repeatPassword",type:s?"text":"password",placeholder:"Password"}),A.jsx(S,{type:"button",onClick:()=>i(!s),children:s?A.jsx(t,{iconName:"icon-eye",width:"16px",height:"16px"}):A.jsx(t,{iconName:"icon-eye-slash",width:"16px",height:"16px"})})]}),A.jsx(g,{name:"repeatPassword",component:"span"})]}),A.jsx(D,{type:"submit",children:"Sign Up"}),A.jsx(P,{to:"/signin",onClick:()=>{a.handleReset()},children:"Sign in"})]})})})},pA=({isRegister:e=!1})=>e?A.jsx(H,{}):A.jsx(K,{});export{pA as A,rA as a,oA as b,tA as c,iA as d,nA as e,aA as f,lA as g,eA as m,sA as t};
